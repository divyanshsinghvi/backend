...
Original file is located at
    https://colab.research.google.com/drive/1GyJHNiRmvuxdi1OGEGkm0uNPHO-RlxDM
"""
...
wget.download('https://raw.githubusercontent.com/covid19india/api/gh-pages/v4/min/data-all.min.json', os.path.join(os.getcwd(),'test.json')) #os.path.join instead of concating string together
#wget.download('https://api.covid19india.org/v4/data-all.json', os.path.join(os.getcwd(),'test.json')) #os.path.join instead of concating string together
